...
import {ImportTelemetryContext, Item, ShareDirection, ShareItemType, ShareType, TelemetryShareRequest} from '../../../telemetry';
import {TelemetryLogger} from '../../../telemetry/util/telemetry-logger';

export class GenerateProfileExportTelemetry {
