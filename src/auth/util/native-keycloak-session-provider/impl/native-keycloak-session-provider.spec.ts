...
describe('NativeKeycloakSessionProvider', () => {
    ...
    describe('provide()', () => {
        it('should pass all login details on api call with sucess access token', (done) => {
            window['device'] = {
                uuid:'some_id',
                platform: 'android'
            }
        ...
        it('should pass all login details on api call with success and validate err', (done) => {
            window['device'] = {
                uuid:'some_id',
                platform: 'android'
            }
...
export const mockManualLoginConfig: WebviewSessionProviderConfig = {
    'context': 'login',
    'target': {
