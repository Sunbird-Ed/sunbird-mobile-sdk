...
export namespace PartnerEntry {
    ...
    export const getCreateEntry: (() => string) = () => {
        return 'CREATE TABLE IF NOT EXISTS ' + PartnerEntry.TABLE_NAME + ' (' +
            ...
            PartnerEntry.COLUMN_NAME_PARTNER_ID + DbConstants.TEXT_TYPE + ' UNIQUE NOT NULL' + DbConstants.COMMA_SEP +
            PartnerEntry.COLUMN_NAME_KEY + DbConstants.TEXT_TYPE + ' NOT NULL' + DbConstants.COMMA_SEP +
            PartnerEntry.COLUMN_NAME_KEY_ID + DbConstants.INT_TYPE + ' NOT NULL' +
            ' )';
    };
