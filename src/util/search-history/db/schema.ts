...
export namespace SearchHistoryEntry {
    ...
    export const COLUMN_NAME_SEARCH_TERM = 'search_term';
    ...
    export interface SchemaMap {
        ...
        [COLUMN_NAME_SEARCH_TERM]: string;
    ...
    export const getCreateEntry: (() => string) = () => {
        return 'CREATE TABLE IF NOT EXISTS ' + SearchHistoryEntry.TABLE_NAME + ' (' +
            ...
            SearchHistoryEntry.COLUMN_NAME_SEARCH_TERM + DbConstants.SPACE + DbConstants.TEXT_TYPE + DbConstants.COMMA_SEP +
            ...
            'UNIQUE (' + SearchHistoryEntry.COLUMN_NAME_USER_ID + DbConstants.COMMA_SEP + SearchHistoryEntry.COLUMN_NAME_SEARCH_TERM + ') ON CONFLICT REPLACE' +
            ' )';
    };
