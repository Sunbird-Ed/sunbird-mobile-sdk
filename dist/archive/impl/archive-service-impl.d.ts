...
export declare class ArchiveServiceImpl implements ArchiveService {
    ...
    constructor(fileService: FileService, dbService: DbService, telemetryService: TelemetryService, zipService: ZipService, deviceInfo: DeviceInfo, networkQueue: NetworkQueue, sdkConfig: SdkConfig);
